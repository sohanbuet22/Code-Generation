...
public:
  enum {
    ...
    DECOP = 25, NOT = 26, RELOP = 27, LOGICOP = 28, ASSIGNOP = 29, COMPOUND_ASSIGNOP = 30, 
  ...
  class  MultiVarDeclWithInitContext : public Declaration_listContext {
  public:
    MultiVarDeclWithInitContext(Declaration_listContext *ctx);
  ...
  class  SiglVarDeclWithInitContext : public Declaration_listContext {
  public:
    SiglVarDeclWithInitContext(Declaration_listContext *ctx);
  ...
  class  Expression_to_logic_expression_with_compound_assignopContext : public ExpressionContext {
  public:
    Expression_to_logic_expression_with_compound_assignopContext(ExpressionContext *ctx);

    VariableContext *variable();
    antlr4::tree::TerminalNode *COMPOUND_ASSIGNOP();
    Logic_expressionContext *logic_expression();
