...
public:
   ...
   */
    ...
    virtual std::any visitMultiVarDeclWithInit(CSubsetParser::MultiVarDeclWithInitContext *context) = 0;
    ...
    virtual std::any visitSiglVarDeclWithInit(CSubsetParser::SiglVarDeclWithInitContext *context) = 0;
    ...
    virtual std::any visitExpression_to_logic_expression_with_compound_assignop(CSubsetParser::Expression_to_logic_expression_with_compound_assignopContext *context) = 0;
